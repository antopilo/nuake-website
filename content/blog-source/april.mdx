---
title: April 2025
description: C#, Spatialized Audio, Triggers, Post-processing and a bunch more this month
...
- Triggers
- Post-processing
- Trenchbroom Configurator
- Runtime and game exports
...
# C# support 🧑🏼‍💻
> This is a work in progress and it will probably change a bit while I'm fleshing out the feature

This is a big one that I've been wanting for a while. 
C# is an incredibly popular language for game development, so it only made sense to implement it.

The experience of using a solid language in Nuake has been refreshing to say the least. Wren is still a solid 
language that I want to support along side C#. 

You can now generate a visual studio solution from the editor and Nuake will build your scripts before starting the game.

There is still a lot to be done to make it good enough. It still has rough corners around making the user experience as smooth as it 
could be, but I'm overall happy with how it's turning out.

Here is a quick overview of how it works at the moment:
...
I made a small game the other day to test out the current state of the engine and ended up using triggers on weapons to register hits and it 
...
Games can now be exported to run outside of the editor, though asset packing is not yet available.
It is a very simple and barebone way of sharing your game to your friends. 
...
I'm also constantly improving the editor interface and user experience as I'm working on other features. Here is a recent screenshot of the 
editor. There is still a lot to improve, but it's coming along nicely.

<img src="https://cdn.discordapp.com/attachments/828069636012507150/1231332791388737536/image.png?ex=66369306&is=66241e06&hm=4b78b8d2704e6b6c6328ab324f3b45850a3822f59b88f22e56ea162784d66d34&"/>